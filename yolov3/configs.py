...
TRAIN_CLASSES               = "./model_data/BFSI_logo_names.txt"
TRAIN_ANNOT_PATH            = "./model_data/BFSI_logo_train.txt"
TRAIN_LOGDIR                = "log"
TRAIN_CHECKPOINTS_FOLDER    = "checkpoints"
TRAIN_MODEL_NAME            = "yolov3_custom_logo"
TRAIN_LOAD_IMAGES_TO_RAM    = True # faster training, but need more RAM
TRAIN_BATCH_SIZE            = 8 # 4 or 8
TRAIN_INPUT_SIZE            = 416
TRAIN_DATA_AUG              = False # not recommended for Bank Logo data
TRAIN_TRANSFER              = True
TRAIN_FROM_CHECKPOINT       = False # "checkpoints/yolov3_custom_2"
TRAIN_LR_INIT               = 1e-4
TRAIN_LR_END                = 1e-6
TRAIN_WARMUP_EPOCHS         = 2
TRAIN_EPOCHS                = 100 # 50 or 100

# TEST options
TEST_ANNOT_PATH             = "./model_data/BFSI_logo_test.txt"
TEST_BATCH_SIZE             = 4 # 2 or 4
TEST_INPUT_SIZE             = 416
TEST_DATA_AUG               = False
